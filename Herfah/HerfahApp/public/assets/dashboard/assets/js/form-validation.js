...
document.addEventListener('DOMContentLoaded', function (e) {
  (function () {
    const formValidationExamples = document.getElementById('formValidationExamples'),
      formValidationSelect2Ele = jQuery(formValidationExamples.querySelector('#formValidationSelect2')),
    ...
    const fv = FormValidation.formValidation(formValidationExamples, {
      fields: {
        profilePic: {
          validators: {
            notEmpty: {
              message: 'Please select the image for profile '
            }
          }
        },
        coverPic: {
          validators: {
            notEmpty: {
              message: 'Please select the image for cover'
            }
          }
        },
        selectDepartment: {

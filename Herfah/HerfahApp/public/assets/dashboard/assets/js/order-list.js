...
$(function () {
  ...
  if (dt_order_table.length) {
    var dt_products = dt_order_table.DataTable({
        ajax: {
            url: routeOfFetchOrder,
            type: 'GET',
            dataSrc: function (response) {
              return response[dataSrcFetchOrder];
          }
        },
      columns: [
        {
          ...
          },
          {
            ...
            data: null,
            render: function (data, type, meta) {
              var date = new Date(data.created_at); // convert the date string to a Date object
          ...
          },
        {
            ...
            render: function (data, type, meta) {
              ...
              // Creates full output for row
              var $row_output = '<a href="app-ecommerce-order-details.html"><span>#' + $client_id + '</span></a>';
              return $row_output;
            }
          },
        {
            ...
            render: function (data, type, meta) {
              ...
              // Creates full output for row
              var $row_output = '<a href="app-ecommerce-order-details.html"><span>#' + $worker_id + '</span></a>';
              return $row_output;
            }
          },
          {
            ...
            data: null,
            render: function (data, type, meta) {
              var date = new Date(data.startDate); // convert the date string to a Date object
              var formattedDate = date.toLocaleDateString('en-US', {
                month: 'short',
                day: 'numeric',
                year: 'numeric',
          ...
          },
          {
            ...
            render: function (data, type, meta) {
              ...
              // Creates full output for row
              var $row_output = '<a href="app-ecommerce-order-details.html"><span>#' + $Num_Days + '</span></a>';
              return $row_output;
            }
          },
          {
            ...
            render: function (data, type, meta) {
              ...
              // Creates full output for row
              var $row_output = '<a href="app-ecommerce-order-details.html"><span>#' + $Amount + '</span></a>';
              return $row_output;
            }
          },
          {

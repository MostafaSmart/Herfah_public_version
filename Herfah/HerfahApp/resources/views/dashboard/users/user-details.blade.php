                        ...
                        <div class="customer-avatar-section">
                          <div class="d-flex align-items-center flex-column">
                            <img
                              ...
                              src="assets/dashboard/assets/img/avatars/15.png"
                              height="110"
                              width="110"
                              alt="User avatar" />
                            <div class="customer-info text-center">
                              <h4 class="mb-1">Lorine Hischke</h4>
                              <small> ID #634759</small>
                            </div>
                          </div>
                        </div>
                        ...
                        <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                          <li class="nav-item">
                            <button
                              ...
                              aria-selected="true">
                              <i class="ti ti-user ti-xs me-1"></i> Overview
                            </button>
                          </li>
                          <li class="nav-item">
                            <button
                              ...
                              aria-selected="false">
                              <i class="tf-icons ti ti-user ti-xs me-1"></i> Security
                            </button>
                          </li>
                          <li class="nav-item">
                            <button
                              ...
                              aria-selected="false">
                              <i class="tf-icons ti ti-message-dots ti-xs me-1"></i> Address
                            </button>
                          </li>
                          <li class="nav-item">
                            <button
                              ...
                              aria-selected="false">
                              <i class="tf-icons ti ti-message-dots ti-xs me-1"></i> Notifications
                            </button>
                          </li>
                        </ul>
                          ...
                          <tbody>
                            <tr>
                              <td class="text-truncate">
                                <i class="mb-1 ti ti-brand-windows text-info me-3"></i> Chrome on Windows
                              </td>
                            ...
                            <tr>
                              <td class="text-truncate">
                                <i class="mb-1 ti ti-device-mobile text-danger me-3"></i> Chrome on iPhone
                              </td>
                            ...
                            <tr>
                              <td class="text-truncate">
                                <i class="mb-1 ti ti-brand-android text-success me-3"></i> Chrome on Android
                              </td>
...
@section('script')
    ...
    <script src="assets/dashboard/assets/js/user-detail.js"></script>
@endsection

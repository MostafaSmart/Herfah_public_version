...
@section('content')
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-2">
                  <span class="text-muted fw-light">العملاء / تفاصيل العميل  /</span> مراجعة
                </h4>
                ...
                <div
                  ...
                  <div class="mb-2 mb-sm-0">
                    <h4 class="mb-1">رقم العميل #634759</h4>
                    <p class="mb-0">Aug 17, 2020, 5:48 (ET)</p>
                  </div>
                  <button type="button" class="btn btn-label-danger delete-customer">حذف العميل</button>
                </div>
                        ...
                        <div class="customer-avatar-section">
                          <div class="d-flex align-items-center flex-column">
                            <img
                              ...
                              src="/assets/dashboard/assets/img/avatars/3.png"
                              height="110"
                              width="110"
                              alt="User avatar" />
                            <div class="customer-info text-center">
                              <h4 class="mb-1">{{ $client->user->name }} {{ $client->user->l_name }}</h4>
                              <small class="get-id" id="{{ $client->id }}"> ID #{{ $client->id }}</small>
                            </div>
                          </div>
                        </div>
                        <div class="info-container">
                          ...
                          <ul class="list-unstyled">
                            ...
                            <li class="mb-3">
                              ...
                              <span>{{ $client->user->birthdate }}</span>
                            </li>
                            <li class="mb-3">
                        ...
                        <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                          <li class="nav-item">
                            <button
                              ...
                              aria-selected="true">
                              <i class="ti ti-user ti-xs me-1"></i> اساسي
                            </button>
                          </li>
                          <li class="nav-item">
                            <button
                              ...
                              aria-selected="false">
                              <i class="tf-icons ti ti-message-dots ti-xs me-1"></i> العناوبن
                            </button>
                          </li>
                          <li class="nav-item">
                            <button
                              ...
                              <div class="col-md-6 mb-4">
                                <div class="card h-100">
                                  <div class="card-body">
                                    ...
                                    <div class="card-info">
                                      <h4 class="card-title mb-3">عدد الطلبات</h4>
                                      <div class="d-flex align-items-baseline mb-1 gap-1">
                                        <h4 class="text-primary mb-0">{{ $client->orders_count }}</h4>
                                        <p class="mb-0">طلب</p>
                                      </div>
                              ...
                              <div class="col-md-6 mb-4">
                                <div class="card h-100">
                                  <div class="card-body">
                                    ...
                                    <div class="card-info">
                                      <h4 class="card-title mb-3">المبالغ الذي تم انفاقها</h4>
                                      <h4 class="text-primary mb-0">{{ $totalAmount }}ريال يمني </h4>
...
@section('script')
<script>
    var clientId = $('.get-id').attr('id');
    var routeGetOrders = '/clientOrders' + '/' + clientId,;
    var dataOrders = 'clientOrder';
</script>
    <!-- Vendors JS -->
    ...
    <script src="/assets/dashboard/assets/js/customer-detail.js"></script>
@endsection

    ...
    <script src="/assets/dashboard/assets/vendor/libs/node-waves/node-waves.js"></script>
    <script src="/assets/dashboard/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
    <script src="/assets/dashboard/assets/vendor/libs/hammer/hammer.js"></script>
    ...
    <!-- Page JS -->
    <script src="/assets/dashboard/assets/js/app-ecommerce-dashboard.js"></script>

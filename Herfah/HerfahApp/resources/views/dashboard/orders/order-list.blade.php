...
@section('content')
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-2"><span class="text-muted fw-light"></span> Order List</h4>
...
@section('script')
<script>
    var routeOfFetchOrder = '{{ route('fetch.All.Order') }}';
    var dataSrcFetchOrder = 'clientOrder';
</script>
    <!-- Vendors JS -->
    <script src="/assets/dashboard/assets/vendor/libs/datatables-bs5/datatables-bootstrap5.js"></script>

    <!-- Page JS -->
    <script src="/assets/dashboard/assets/js/order-list.js"></script>
@endsection

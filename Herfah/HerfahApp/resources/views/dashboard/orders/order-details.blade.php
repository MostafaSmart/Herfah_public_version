...
<link rel="stylesheet" href="assets/dashboard/assets/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css" />
...
@section('content')
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-2"><span class="text-muted fw-light"></span>تفاصيل الطلب</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-lg-4">
                    <div class="card mb-4">
                      <div class="card-header">
                        <h6 class="card-title m-0">تفاصيل العميل</h6>
                      </div>
                      <div class="card-body">
                    ...
                    <div class="card mb-4">
                      <div class="card-header d-flex justify-content-between">
                        <h6 class="card-title m-0">العنوان والدفع</h6>
                        <h6 class="m-0">
...
@section('script')
    ...
    <!-- Page JS -->
    <script src="assets/dashboard/assets/js/order-details.js"></script>
